...
def add_colorful_mask(image, mask, class_index):
    ...
    image[mask == class_index['kidney_cyst'], 1] = 255  # kidney cyst (0,255,0)
...
def make_avi(case_name, plane, args):
    ...
    video_name = os.path.join(args.video_save_path, plane, case_name+'.mp4')
    ...
    # Use MP4V codec for MP4 video
    fourcc = cv2.VideoWriter_fourcc(*'mp4v')
    video = cv2.VideoWriter(video_name, fourcc, args.FPS, (width, height))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--abdomen_atlas', dest='abdomen_atlas', type=str, default='H:\\Weakly_revision\\',
                        help='the directory of the AbdomenAtlas dataset',
                       )
    parser.add_argument("--png_save_path", dest='png_save_path', type=str, default='F:\\wr_out\\materials',
                        help='the directory of png for each CT slice',
                       )
    parser.add_argument("--video_save_path", dest='video_save_path', type=str, default='F:\\wr_out\\videos',
                        help='the directory for saving videos',
                       )
    parser.add_argument("--gif_save_path", dest='gif_save_path', type=str, default='F:\\wr_out\\gifs',
                        help='the directory for saving gifs',
                       )
    parser.add_argument("--minimal_slices", dest='minimal_slices', type=int, default=90,
                        help='the minimal value for the number of CT slices',
                       )
    parser.add_argument("--FPS", dest='FPS', type=float, default=15,
