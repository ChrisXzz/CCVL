...
def main():
    ...
    parser.add_argument('--source_path', default = 'G:\\TODO\\imagecas_reorganized\\', help='The source directory containing the folders to rename.')
    parser.add_argument('--destination_path', default = 'G:\\TODO\\id_map\\', help='The destination directory to save the renamed folders.')
    parser.add_argument('--prefix', default='BDMAP_', help='The prefix for the new folder names.')
    parser.add_argument('--start_number', type=int, default=14639, help='The starting number for the new folder names.')
    ...
    excel_path = os.path.join(args.destination_path, "imagecas_rename_mapping.xlsx")
