...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='F:\\Weakly_revision\\', help='The path of totalsegmentator data')
    parser.add_argument('--save_dir', default='H:\\Weakly_revision\\', help='The saving path after reorganizing')
