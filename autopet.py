...
def match(raw_base_dir, mask_base_dir, new_base_dir):
    ...
    # Loop through each case in the raw dataset directory
    for case in os.listdir(raw_base_dir):
        ...
        if os.path.isfile(case_raw_path) and case_raw_path.endswith('.nii.gz'):
            ...
            # Create segmentations directory and copy mask data
...
def extract_features(data_folder, feature_dict):
    ...
    for case in os.listdir(data_folder):
        ...
        if os.path.isdir(case_path):
            ...
            # Generate annotation file names based on case names
            ...
            if os.path.isfile(segmentation_file):
                ...
                # Iterate through all features in the dictionary
                for feature_name, feature_value in feature_dict.items():
                    ...
                    if np.any(feature_mask):
                        ...
                        # Save the new NIfTI image to the segments folder
...
def main():
    ...
    parser.add_argument('--data_path', default='/ccvl/net/ccvl15/zzhou82/PublicAbdominalData/19_AutoPet_Nifti/', 
                        help='The path of your data')
    parser.add_argument('--data_path_mask', default='/ccvl/net/ccvl15/zzhou82/PublicAbdominalData/20_DAP_Atlas/', 
                        help='The path of your data')
    parser.add_argument('--save_dir', default='/ccvl/net/ccvl15/xinze/autopet_reorganized/', help='The saving path after 1 by 1 matched')
