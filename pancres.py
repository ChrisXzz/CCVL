...
def pancreas_reorganized(src_directory, target_directory):
    ...
    for case_folder in os.listdir(src_directory):
        ...
        if os.path.isdir(case_path):
            ...
            new_case_folder = os.path.join(target_directory, f'{"Pancreas"}_{case_folder}')
...
def main():
    ...
    parser.add_argument('--data_path', default='/ccvl/net/ccvl15/zzhou82/PublicAbdominalData/15_Pancreas/Zenodo_upload/data/', 
                        help='The path of your data')
    parser.add_argument('--save_dir', default='/ccvl/net/ccvl15/xinze/pancreas_reorganize/', help='The saving path after 1 by 1 matched')
